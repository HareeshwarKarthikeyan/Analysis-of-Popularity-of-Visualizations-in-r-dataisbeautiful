...
with st.container():
    ...
    with col2:
        ...
        st.markdown("##### As we explore the data points looking at their tooltip information, it can be noticed that among the posts with more number of colors, the posts that trend tend to utilize bright and contrasting colors compared to some relatively dull ones in the non trending posts.")
